<x-layout title="Edit Siswa {{ $input_table->name }}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('dashboard.input-table.update', $input_table->id) }}" method="POST"
                ...
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('name', $input_table->name) }}" name="name"
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{ old('nis', $input_table->nis) }}" name="nis"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="grade_id" class="form-select @error('grade_id') is-invalid @enderror"
                                ...
                                @forelse ($grades as $grade)
                                    <option
                                        {{ $grade->id === old('grade_id', $input_table->grade_id) ? 'selected' : '' }}
                        ...
                        <div class="mb-3">
                            ...
                            <select name="region_id" class="form-select @error('region_id') is-invalid @enderror"
                                ...
                                @forelse ($regions as $region)
                                    <option
                                        {{ $region->id === old('region_id', $input_table->region->id) ? 'selected' : '' }}
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('username', $input_table->user->username) }}"
